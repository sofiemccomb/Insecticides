...
Next Week Tasks:
1. Make sure R Markdown HTML looks good for each script?
2. Put important meeting notes/decisions as docs in repo (such as downloading coa)
3. Figure out what wanting from below and copy over
4. Eventually figure out where to put some stargazer script
