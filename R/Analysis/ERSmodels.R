...
#Write csv for each of the created dataframes
write_csv(ERS_df, "Data/Analysis/df/ERS/ERS_df_forest.csv")
write_csv(ERS_df_coef, "Data/Analysis/df/ERS/ERS_df_coeftest_forest.csv") # No metadata yet
#write_csv(cp_vif, "Data/Analysis/df/ERS/ERS_vif_forest.csv")
...
#Write csv for each of the created dataframes
write_csv(ERS_df, "Data/Analysis/df/ERS/ERS_df_shrubgrass.csv")
write_csv(ERS_df_coef, "Data/Analysis/df/ERS/ERS_df_coeftest_shrubgrass.csv") # No metadata yet
#write_csv(cp_vif, "Data/Analysis/df/ERS/ERS_vif_shrubgrass.csv")
