...
write_csv(cp_df, "Data/Analysis/df/CP/cp_df_plandcrops.csv")
write_csv(cp_df_coef, "Data/Analysis/df/CP/cp_df_coeftest_plandcrops.csv") # No metadata yet
write_csv(cp_vif, "Data/Analysis/df/CP/cp_vif_plandcrops.csv")
...
#Write csv for each of the created dataframes and rda for the correlation matrix list (save under Data/Analysis/df/CP)
write_csv(cp_df, "Data/Analysis/df/CP/cp_df_forest_plandcrops.csv")
write_csv(cp_df_coef, "Data/Analysis/df/CP/cp_df_coeftest_forest_plandcrops.csv") # No metadata yet
write_csv(cp_vif, "Data/Analysis/df/CP/cp_vif_forest_plandcrops.csv")
...
#Write csv for each of the created dataframes and rda for the correlation matrix list (save under Data/Analysis/df/CP)
write_csv(cp_df, "Data/Analysis/df/CP/cp_df_shrubgrass_plandcrops.csv")
write_csv(cp_df_coef, "Data/Analysis/df/CP/cp_df_coeftest_shrubgrass_plandcrops.csv") # No metadata yet
write_csv(cp_vif, "Data/Analysis/df/CP/cp_vif_shrubgrass_plandcrops.csv")
