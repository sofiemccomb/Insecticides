...
source ("R/NLCD.R")
#Output saved as nlcd.csv saved under Data/df
...
ERS<-readxl::read_xls("Data/ERS/ERSRegions_To_Counties.xls")
ERS<-ERS[,1:3]
...
coa<-readr::read_csv("Data/df/coa.csv")
cdl<-readr::read_csv("Data/df/cdl.csv")
nlcd<-readr::read_csv("Data/df/nlcd.csv")
...
#Explore the COA data missing (about 31 rows)

#Add in other cropland calculations here for regression?

#Write fulldata to df folder be used in regression analyses
    write_csv(fulldata, "Data/df/fulldata.csv")
